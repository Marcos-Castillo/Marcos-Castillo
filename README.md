...
<h1 align="center">
  ¡Hola! Soy Marcos Castillo, Backend Developer.
</h1>

<p align="center">
  .NET (C#) & Java · APIs e Integraciones · SQL Server
</p>
...
- [**appChat**](https://github.com/Marcos-Castillo/appChat): Aplicación de mensajería con backend en tiempo real.

- [**Sistema de ventas en Spring Boot**](https://github.com/Marcos-Castillo/tp-grupo-14): Trabajo práctico final de Spring Boot con Java y MySQL (Codo a Codo 4.0).
...
- **Responsabilidades:**
  - Desarrollo y mantenimiento de APIs e integraciones (facturación y sistemas de Puntos de Venta) con Spring Boot, Java, C#/.NET y Microsoft SQL Server.
  - Liderazgo en el desarrollo del sistema de impresión de precios en Android (Java) con impresión térmica Bluetooth.
  - Trabajo con Git, GitHub, MySQL y metodologías ágiles (Scrum, LeSS).
...
### Técnico de Soporte de TI (nivel 2) en Jazzplat España
- **Ubicación:** España (CAT Pymes Activaciones)
- **Fechas:** _verificar fechas en LinkedIn_
- **Responsabilidades:**
  - Soporte técnico de nivel 2 para campañas de activaciones de Pymes (CAT).
  - Diagnóstico y resolución de incidencias de hardware, software, telefónica y redes, gestionando incidentes en mesa de ayuda y escalando al nivel correspondiente.
...
- **Frameworks y bibliotecas:** Spring Boot, .NET, Angular, React, Node.js, Bootstrap, Swagger
- **Bases de datos:** MySQL, Microsoft SQL Server, Firebase
- **Herramientas y plataformas:** Git, GitHub, Linux, Windows, Android, Firebase
- **Hardware y comunicaciones:** Impresión térmica ESC/POS, Bluetooth
- **Metodologías ágiles:** Scrum, Agile, Waterfall, LeSS (Large-Scale Scrum)

## Idiomas

- Español: nativo
- Inglés: intermedio (B1) — según EF SET (2022)

## Educación, Licencias y Certificaciones

| Título                                       | Institución                                   | Año       |
|----------------------------------------------|-----------------------------------------------|-----------|
| Desarrollo de Aplicaciones Web - Node.js (Talento Tech) | Gobierno de la Ciudad de Buenos Aires  | abr. 2026 |
| Liderazgo y Gestión de Equipos (125 h)       | UNIR - Universidad Internacional de La Rioja  | abr. 2026 |
| Certificación intermedia de Analista Programador | Instituto Superior Santo Domingo           | mar. 2026 |
| Técnico Superior en Análisis de Sistemas de Computación | Instituto Superior Santo Domingo      | 2026      |
| Inmersión IA + Google Gemini                 | United Latino Students Association             | sept. 2025 |
| Desarrollo de Videojuegos con Unity 2D (Talento Tech) | Gobierno de la Ciudad de Buenos Aires  | ago. 2025 |
| LFD121: Developing Secure Software           | The Linux Foundation                           | feb. 2025 |
| LFS101: Introduction to Linux                | The Linux Foundation                           | nov. 2024 |
...
| Java Avanzado con Spring Boot                | Codo a Codo 4.0 - Ciudad de Buenos Aires       | dic. 2023 |
